...
item2 = Item(user_id=1, name="Shinguards", description="Shinguards!",
             category=category1)
session.add(item2)
session.commit()

item3 = Item(user_id=1, name="Jersey", description="Jersey!",
             category=category1)
session.add(item3)
session.commit()

item4 = Item(user_id=1, name="Soccer Cleats", description="Soccer Cleats!",
             category=category1)
session.add(item4)
session.commit()
...
item1 = Item(user_id=1, name="Bat", description="Bat!",
             category=category3)
session.add(item1)
session.commit()
